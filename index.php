        ...
        <main>
                        ...
                        <div class="col-md-3 tp-btn-trigger">
                            <div class="hero-banner-one__circle tp-btn-bounce">
                                <div class="hero-banner-one__circle__logo">
                                    <img src="img/techscalify.png" alt="Tech Scalify Logo - IT Services Company" width="150" height="150" fetchpriority="high">
                                </div>
                        ...
                        <div class="col-xl-6 d-flex align-items-center">
                            <div class="about-one__content">
                                <div class="sec-title text-left">
                                    ...
                                    <h6 class="sec-title__tagline bw-split-text">About Tech Scalify</h6>
                                    <!-- /.sec-title__tagline -->

                                    <h3 class="sec-title__title bw-split-text">A Scalable Digital Experience Built for
                                        Growth</h3><!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <div class="about-one__box">
                                    <div class="about-one__box__icon"><i class="flaticon-check"></i></div>
                                    <h5 class="about-one__box__title">Digital Transformation & Automation</h5>
                                    <p class="about-one__box__text">
                                        We modernize businesses with cloud adoption, intelligent automation,
                                        and data-driven systems that improve efficiency, reduce costs, and accelerate
                                        growth.
                                    </p>
                                </div>
                                <div class="about-one__box">
                                    <div class="about-one__box__icon"><i class="flaticon-check"></i></div>
                                    <h5 class="about-one__box__title">Custom Software & Cloud Solutions </h5>
                                    <p class="about-one__box__text">
                                        From custom web and mobile applications to secure cloud infrastructure,
                                        we design future-ready solutions tailored to your business needs.
                                    </p>
                                </div>
                                <div class="about-one__content__btn">
                                    ...
                                    <!-- <div class="about-one__content__author">
                                                <img src="assets/images/resources/about-author-1.jpg" alt="Tech Scalify">
                            ...
                            <div class="about-one__image" data-speed="1.1" data-lag="0">
                                ...
                                <div class="about-one__image__experiance count-box" data-aos="flip-up"
                                    ...
                                    <h3 class="about-one__image__experiance__count"><span class="count-text"
                                            data-stop="25" data-speeds="1500"></span>+</h3>
            ...
            <section class="service-one">
                <div class="container">
                    ...
                    <div class="service-one__carousel lotech-owl__carousel lotech-owl__carousel--basic-nav owl-carousel owl-theme"
                        data-owl-options='{
                                                        "items": 1,
                                                        "margin": 24,
                                                        "loop": true,
            ...
            <section class="cta-one">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-4" data-aos="flip-right" data-aos-duration="1300"
                            data-aos-delay="400">
                    ...
                    <div class="row d-flex align-items-end">
                        <div class="col-lg-6">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-text">Build a Strong Digital <br>
            ...
            <section class="portfolio-one">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="sec-title text-left">
                                ...
                                <h6 class="sec-title__tagline bw-split-text">Latest Project</h6>
                                <!-- /.sec-title__tagline -->

                                <h3 class="sec-title__title bw-split-text">Our Latest case Studies</h3>
                                <!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                        </div>
                ...
                <div class="text-splite-up">
                    <div class="portfolio-one__carousel lotech-owl__carousel owl-carousel lotech-owl__carousel--custom-nav"
                        data-owl-nav-prev=".portfolio-one__prev" data-owl-nav-next=".portfolio-one__next"
                        data-owl-options='{
				"items": 1,
				"margin": 24,
				"loop": true,
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-text">Every single day update<br> for technology.
                                </h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                        </div>
                    ...
                    <div class="row gutter-y-30 gutter-x-24">
                        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1200"
                            ...
                            <div class="funfact-one__item count-box">
                                <h3 class="funfact-one__item__count"><span class="count-text" data-stop="85"
                                        data-speeds="1500"></span>%</h3><!-- /.funfact-one__item__count -->
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1300"
                            data-aos-delay="200">
                            <div class="funfact-one__item count-box">
                                <h3 class="funfact-one__item__count"><span class="count-text" data-stop="22"
                                        data-speeds="1500"></span>+</h3><!-- /.funfact-one__item__count -->
                                <div class="funfact-one__item__divider"></div><!-- /.funfact-one__item__divider -->
                                <p class="funfact-one__item__text">Years OF Experience</p>
                                <!-- /.funfact-one__item__text -->
                            </div><!-- /.funfact-one__item -->
                        </div>
                        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1400"
                            data-aos-delay="300">
                            <div class="funfact-one__item count-box">
                                <h3 class="funfact-one__item__count"><span class="count-text" data-stop="12"
                                        data-speeds="1500"></span>+</h3><!-- /.funfact-one__item__count -->
                                <div class="funfact-one__item__divider"></div><!-- /.funfact-one__item__divider -->
                                <p class="funfact-one__item__text">Awards</p><!-- /.funfact-one__item__text -->
                            </div><!-- /.funfact-one__item -->
                        </div>
                        <div class="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration="1500"
                            data-aos-delay="400">
                            <div class="funfact-one__item count-box">
                                <h3 class="funfact-one__item__count"><span class="count-text" data-stop="55"
                                        data-speeds="1500"></span>K</h3><!-- /.funfact-one__item__count -->
                                <div class="funfact-one__item__divider"></div><!-- /.funfact-one__item__divider -->
                                <p class="funfact-one__item__text">Satisfied Clients</p>
                                <!-- /.funfact-one__item__text -->
                            </div><!-- /.funfact-one__item -->
                        </div>
                    </div>
...
<!-- Critical JavaScript: jQuery must load first (synchronous) -->
<script src="assets/vendors/jquery/jquery-3.7.0.min.js"></script>

<!-- Defer non-critical JavaScript to improve page load -->
...
<script defer src="assets/vendors/date-time-picker/jquery.datetimepicker.min.js"></script>
...
<!-- GSAP: Load with defer for better performance -->
<script defer src="assets/vendors/gsap/gsap.js"></script>
<script defer src="assets/vendors/gsap/scroll-smoother.js"></script>
<script defer src="assets/vendors/gsap/scroll-trigger.js"></script>
<script defer src="assets/vendors/gsap/scroll-to-plugin.js"></script>
<script defer src="assets/vendors/gsap/split-text.js"></script>
<script defer src="assets/vendors/gsap/gsap-lotech.js"></script>

<!-- Template JS: Must load last, after all dependencies -->
<script defer src="assets/js/lotech.js"></script>
</body>
