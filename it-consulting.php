<?php
$page_title = 'IT Strategy Consulting Services | Techscalify';
$page_meta_description = 'Techscalify provides IT strategy consulting to align technology with business goals. Digital transformation, scalability, and technology roadmap for growing businesses.';
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__content">
                    <h1 class="page-header__title">IT Strategy Consulting</h1>
