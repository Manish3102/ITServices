<?php include 'layout/header.php';?>
        ...
        <div id="smooth-wrapper">
            <div id="smooth-content">
                ...
                <section class="contact-map section-space-top">
                    <div class="container">
                ...
                </section><!-- /.contact-map section-space-top -->

                <section class="contact-info section-space-bottom">
                    <div class="container">
                        <div class="row gutter-y-24">
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                ...
                <section class="contact-three section-space-bottom">
                    <div class="container">
                        <div class="row gutter-y-30">
                            <div class="col-xl-8 col-lg-7">
                                <div class="contact-three__wrapper">
                                    <div class="sec-title text-left">

                                        <h6 class="sec-title__tagline bw-split-text">Contact Now</h6><!-- /.sec-title__tagline -->

                                        <h3 class="sec-title__title bw-split-text">Get In Touch with Us</h3><!-- /.sec-title__title -->
                                    </div><!-- /.sec-title -->
                ...
                </section><!-- /.contact-three section-space-bottom -->
